...
#
# Generated by export_simulation on Mon Nov 13 08:17:24 +0800 2017
#
################################################################################
...
switch to the './FIFO_AD_ip.sh' script.

./FIFO_AD_ip.sh -reset_run
...
./FIFO_AD_ip.sh -noclean_files

For more information on the script, please type './FIFO_AD_ip.sh -help'.
