...
#
# Generated by Vivado on Mon Nov 13 08:17:33 +0800 2017
...
# Script info
echo -e "PLL_ip.sh - Script generated by export_simulation (Vivado v2017.2 (64-bit)-id)\n"
...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot PLL_ip xil_defaultlib.PLL_ip xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  $xv_path/bin/xsim PLL_ip -key {Behavioral:sim_1:Functional:PLL_ip} -tclbatch cmd.tcl -log simulate.log
}
