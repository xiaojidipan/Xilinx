...
HD_PWD='C:/XD58_test/XD58_Artix_100T_project/Project.runs/sub_BD_MY_AXI_MASTER_FULL_ip_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sub_BD_MY_AXI_MASTER_FULL_ip_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sub_BD_MY_AXI_MASTER_FULL_ip_0_1.tcl
