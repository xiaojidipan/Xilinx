...
#
# Generated by export_simulation on Tue Nov 21 16:35:29 +0800 2017
#
################################################################################
...
switch to the './FIFO_time_code_ip.sh' script.

./FIFO_time_code_ip.sh -reset_run
...
./FIFO_time_code_ip.sh -noclean_files

For more information on the script, please type './FIFO_time_code_ip.sh -help'.
