...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(user_wr_en, user_rd_en, user_wr_base_addr, 
  ...
  master_axi_init_txn, master_axi_txn_done, master_axi_error, master_axi_aclk, 
  master_axi_aresetn, master_full_axi_awid, master_full_axi_awaddr, 
  master_full_axi_awlen, master_full_axi_awsize, master_full_axi_awburst, 
  master_full_axi_awlock, master_full_axi_awcache, master_full_axi_awprot, 
  master_full_axi_awqos, master_full_axi_awuser, master_full_axi_awvalid, 
  master_full_axi_awready, master_full_axi_wdata, master_full_axi_wstrb, 
  master_full_axi_wlast, master_full_axi_wuser, master_full_axi_wvalid, 
  master_full_axi_wready, master_full_axi_bid, master_full_axi_bresp, 
  master_full_axi_buser, master_full_axi_bvalid, master_full_axi_bready, 
  master_full_axi_arid, master_full_axi_araddr, master_full_axi_arlen, 
  master_full_axi_arsize, master_full_axi_arburst, master_full_axi_arlock, 
  master_full_axi_arcache, master_full_axi_arprot, master_full_axi_arqos, 
  master_full_axi_aruser, master_full_axi_arvalid, master_full_axi_arready, 
  master_full_axi_rid, master_full_axi_rdata, master_full_axi_rresp, 
  master_full_axi_rlast, master_full_axi_ruser, master_full_axi_rvalid, 
  master_full_axi_rready)
/* synthesis syn_black_box black_box_pad_pin="user_wr_en,user_rd_en,user_wr_base_addr[31:0],user_rd_base_addr[31:0],user_wr_len[15:0],user_rd_len[15:0],user_wr_burst_len[7:0],user_rd_burst_len[7:0],user_wr_data_in[31:0],user_wr_satisfy,user_rd_data_en,read_data_val,read_data_out[31:0],master_axi_init_txn,master_axi_txn_done[1:0],master_axi_error,master_axi_aclk,master_axi_aresetn,master_full_axi_awid[0:0],master_full_axi_awaddr[31:0],master_full_axi_awlen[7:0],master_full_axi_awsize[2:0],master_full_axi_awburst[1:0],master_full_axi_awlock,master_full_axi_awcache[3:0],master_full_axi_awprot[2:0],master_full_axi_awqos[3:0],master_full_axi_awuser[0:0],master_full_axi_awvalid,master_full_axi_awready,master_full_axi_wdata[31:0],master_full_axi_wstrb[3:0],master_full_axi_wlast,master_full_axi_wuser[0:0],master_full_axi_wvalid,master_full_axi_wready,master_full_axi_bid[0:0],master_full_axi_bresp[1:0],master_full_axi_buser[0:0],master_full_axi_bvalid,master_full_axi_bready,master_full_axi_arid[0:0],master_full_axi_araddr[31:0],master_full_axi_arlen[7:0],master_full_axi_arsize[2:0],master_full_axi_arburst[1:0],master_full_axi_arlock,master_full_axi_arcache[3:0],master_full_axi_arprot[2:0],master_full_axi_arqos[3:0],master_full_axi_aruser[0:0],master_full_axi_arvalid,master_full_axi_arready,master_full_axi_rid[0:0],master_full_axi_rdata[31:0],master_full_axi_rresp[1:0],master_full_axi_rlast,master_full_axi_ruser[0:0],master_full_axi_rvalid,master_full_axi_rready" */;
  input user_wr_en;
  input user_rd_en;
