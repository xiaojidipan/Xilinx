...
#
# Generated by export_simulation on Fri Nov 17 11:10:22 +0800 2017
#
################################################################################
...
switch to the './sub_BD.sh' script.
...
./sub_BD.sh -noclean_files

For more information on the script, please type './sub_BD.sh -help'.
