...
// Date        : Wed Nov 29 09:37:40 2017
// Host        : Fred-PC running 64-bit Service Pack 1  (build 7601)
// Command     : write_verilog -force -mode synth_stub
//               C:/XD58_test/XD58_Artix_100T_project/Project.srcs/sources_1/ip/isa_handle_0/isa_handle_0_stub.v
// Design      : isa_handle_0
...
module isa_handle_0(reset, clk, pin_isa_cs, pin_isa_wr, pin_isa_rd, 
  pin_isa_adv, pin_isa_data, isa_getdata, rreg_system_debug1, rreg_system_debug1_valid, 
  ...
  wreg_system_ctrl, wreg_system_ctrl_valid, wreg_system_sel_rtc, 
  wreg_system_sel_rtc_valid, wreg_system_set_rtctime, wreg_system_set_rtctime_valid, 
  wreg_system_sync_minfrq, wreg_system_sync_minfrq_valid, wreg_system_sync_max, 
  wreg_system_sync_max_valid, wreg_system_sync_sel, wreg_system_sync_sel_valid, 
  wreg_system_ch_sel, wreg_system_ch_sel_valid, rreg_mem_status, rreg_mem_status_valid, 
  rreg_mem_data_wr_en, rreg_mem_data_wr_addr, rreg_mem_data_wr_data, wreg_mem_rd_en, 
  wreg_mem_ctrl, wreg_mem_ctrl_valid, wreg_mem_addr, wreg_mem_addr_valid, wreg_mem_len, 
  wreg_mem_len_valid, wreg_mem_rd_data, wreg_mem_rd_len, rreg_ddr_status, 
  rreg_ddr_status_valid, rreg_ddr_data_wr_clk, rreg_ddr_data_wr_en, 
  rreg_ddr_data_wr_addr, rreg_ddr_data_wr_data, wreg_ddr_ctrl, wreg_ddr_ctrl_valid, 
  wreg_ddr_addr, wreg_ddr_addr_valid, wreg_ddr_len, wreg_ddr_len_valid, wreg_out_ctrl, 
  wreg_out_ctrl_valid, wreg_out_sel, wreg_out_sel_valid, wreg_out_level, 
  wreg_out_level_valid, wreg_out_startmode, wreg_out_startmode_valid, 
  wreg_out_start_targettime, wreg_out_start_targettime_valid, wreg_out_start_subtime, 
  wreg_out_start_subtime_valid, wreg_out_start_subnum, wreg_out_start_subnum_valid, 
  wreg_out_start_subcycle, wreg_out_start_subcycle_valid, wreg_out_start_trigmode1, 
  wreg_out_start_trigmode1_valid, wreg_out_start_trigmode2, 
  ...
  wreg_out_time_rd_en, wreg_out_time_rd_data, wreg_out_time_rd_len, wreg_ch_zero_cal, 
  wreg_ch_zero_cal_valid, wreg_ch_sample_rate, wreg_ch_sample_rate_valid, 
  wreg_ch_sign_handle, wreg_ch_sign_handle_valid, wreg_ch_main_amp, 
  wreg_ch_main_amp_valid, wreg_ch_pre_amp, wreg_ch_pre_amp_valid, wreg_ch_v_amp, 
  wreg_ch_v_amp_valid, wreg_ch_i_amp, wreg_ch_i_amp_valid, wreg_ch_noise_comp, 
  wreg_ch_noise_comp_valid, wreg_ch_noise_amp_cof, wreg_ch_noise_amp_cof_valid, 
  wreg_ch_noise_delay, wreg_ch_noise_delay_valid, wreg_ch_start_targettime, 
  wreg_ch_start_targettime_valid, wreg_ch_start_sustime, wreg_ch_start_sustime_valid, 
  wreg_ch_start_susnum, wreg_ch_start_susnum_valid, wreg_ch_start_suscycle, 
  wreg_ch_start_suscycle_valid, wreg_ch_stop_sustime, wreg_ch_stop_sustime_valid, 
  wreg_ch_stop_susnum, wreg_ch_stop_susnum_valid, wreg_ch_stop_suscycle, 
  wreg_ch_stop_suscycle_valid, wreg_ch_trig_threshold_p, 
  ...
  wreg_ch_trig_rmsvalue_valid, wreg_ch_filter_rd_en, wreg_ch_filter_rd_data, 
  wreg_ch_filter_rd_len, rreg_series_status, rreg_series_status_valid, 
  rreg_series_starttime, rreg_series_starttime_valid, rreg_series_stoptime, 
  rreg_series_stoptime_valid, rreg_series_maxdata, rreg_series_maxdata_valid, 
  rreg_series_data_wr_clk, rreg_series_data_wr_en, rreg_series_data_wr_addr, 
  rreg_series_data_wr_data, rreg_series_trigger_starttime, 
  rreg_series_trigger_starttime_valid, rreg_series_trigger_stoptime, 
  rreg_series_trigger_stoptime_valid, wreg_series_ctrl, wreg_series_ctrl_valid, 
  wreg_series_data_type, wreg_series_data_type_valid, wreg_series_sample_cycle, 
  wreg_series_sample_cycle_valid, wreg_series_comp_ratio, wreg_series_comp_ratio_valid, 
  wreg_series_comp_num, wreg_series_comp_num_valid, wreg_series_validmode_data, 
  wreg_series_validmode_data_valid, wreg_series_start_ddraddr, 
  wreg_series_start_ddraddr_valid, wreg_series_stop_ddraddr, 
