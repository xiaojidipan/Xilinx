...
HD_PWD='C:/XD58_test/XD58_Artix_100T_project/Project.runs/FIFO_wr_ddr3_ip_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FIFO_wr_ddr3_ip.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FIFO_wr_ddr3_ip.tcl
