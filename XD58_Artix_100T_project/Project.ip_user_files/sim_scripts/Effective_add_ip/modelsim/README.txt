...
#
# Generated by export_simulation on Fri Nov 17 16:56:37 +0800 2017
#
################################################################################
...
switch to the './Effective_add_ip.sh' script.

./Effective_add_ip.sh -reset_run
...
./Effective_add_ip.sh -noclean_files

For more information on the script, please type './Effective_add_ip.sh -help'.
