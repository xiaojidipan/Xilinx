...
HD_PWD='C:/XD58_test/XD58_Artix_100T_project/Project.runs/Effective_mult_ip_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Effective_mult_ip.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Effective_mult_ip.tcl
