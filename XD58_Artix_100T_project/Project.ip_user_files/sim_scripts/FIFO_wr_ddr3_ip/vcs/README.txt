...
#
# Generated by export_simulation on Fri Nov 17 10:51:14 +0800 2017
#
################################################################################
...
switch to the './FIFO_wr_ddr3_ip.sh' script.

./FIFO_wr_ddr3_ip.sh -reset_run
...
./FIFO_wr_ddr3_ip.sh -noclean_files

For more information on the script, please type './FIFO_wr_ddr3_ip.sh -help'.
