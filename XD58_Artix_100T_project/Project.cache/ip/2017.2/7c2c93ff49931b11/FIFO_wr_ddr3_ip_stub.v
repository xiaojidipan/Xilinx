...
//               decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ FIFO_wr_ddr3_ip_stub.v
...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(rst, wr_clk, rd_clk, din, wr_en, rd_en, dout, full, 
  empty, rd_data_count)
/* synthesis syn_black_box black_box_pad_pin="rst,wr_clk,rd_clk,din[15:0],wr_en,rd_en,dout[31:0],full,empty,rd_data_count[9:0]" */;
  input rst;
  input wr_clk;
  input rd_clk;
  input [15:0]din;
