...
//Date        : Fri Nov 17 11:10:13 2017
//Host        : Fred-PC running 64-bit Service Pack 1  (build 7601)
//Command     : generate_target bd_936a.bd
//Design      : bd_936a
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "bd_936a,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_936a,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=48,numReposBlks=38,numNonXlnxBlks=0,numHierBlks=10,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=Global}" *) (* HW_HANDOFF = "sub_BD_axi_smc_0.hwdef" *) 
module bd_936a
   (M00_AXI_araddr,
    M00_AXI_arburst,
    M00_AXI_arcache,
  ...
  m00_exit_pipeline_imp_1KJ0CMW m00_exit_pipeline
  ...
  m00_nodes_imp_175T6MS m00_nodes
  ...
  s00_entry_pipeline_imp_K4X6GR s00_entry_pipeline
       (.aclk(aclk_1),
        .aresetn(aresetn_2),
  ...
  s00_nodes_imp_PUNOWX s00_nodes
  ...
  s01_entry_pipeline_imp_1MSEIB3 s01_entry_pipeline
       (.aclk(aclk_2),
        .aresetn(aresetn_3),
  ...
  s01_nodes_imp_1HB94LZ s01_nodes
  ...
  s02_entry_pipeline_imp_19SASYA s02_entry_pipeline
       (.aclk(aclk_3),
        .aresetn(aresetn_4),
  ...
  s02_nodes_imp_1G8L9HO s02_nodes
  ...
  switchboards_imp_F7ZDO5 switchboards
...
module m00_exit_pipeline_imp_1KJ0CMW
   (aclk,
    aresetn,
    m_axi_araddr,
    m_axi_arburst,
...
module s00_entry_pipeline_imp_K4X6GR
   (aclk,
    aresetn,
    m_axi_araddr,
    m_axi_arcache,
  ...
  bd_936a_s00mmu_0 s00_mmu
       (.aclk(aclk_1),
        ...
        .s_axi_wstrb(s_axi_1_WSTRB),
        .s_axi_wvalid(s_axi_1_WVALID));
  bd_936a_s00sic_0 s00_si_converter
       (.aclk(aclk_1),
        .aresetn(aresetn_1),
  ...
  bd_936a_s00tr_0 s00_transaction_regulator
       (.aclk(aclk_1),
        .aresetn(aresetn_1),
...
module s01_entry_pipeline_imp_1MSEIB3
   (aclk,
    aresetn,
    m_axi_araddr,
    m_axi_arcache,
  ...
  bd_936a_s01mmu_0 s01_mmu
       (.aclk(aclk_1),
        ...
        .s_axi_rresp(s_axi_1_RRESP),
        .s_axi_rvalid(s_axi_1_RVALID));
  bd_936a_s01sic_0 s01_si_converter
       (.aclk(aclk_1),
        .aresetn(aresetn_1),
  ...
  bd_936a_s01tr_0 s01_transaction_regulator
       (.aclk(aclk_1),
        .aresetn(aresetn_1),
...
module s02_entry_pipeline_imp_19SASYA
   (aclk,
    aresetn,
    m_axi_araddr,
    m_axi_arcache,
  ...
  bd_936a_s02mmu_0 s02_mmu
       (.aclk(aclk_1),
        ...
        .s_axi_wstrb(s_axi_1_WSTRB),
        .s_axi_wvalid(s_axi_1_WVALID));
  bd_936a_s02sic_0 s02_si_converter
       (.aclk(aclk_1),
        .aresetn(aresetn_1),
  ...
  bd_936a_s02tr_0 s02_transaction_regulator
       (.aclk(aclk_1),
        .aresetn(aresetn_1),
...
module switchboards_imp_F7ZDO5
   (M00_SC_AR_info,
    M00_SC_AR_payld,
    M00_SC_AR_recv,
    M00_SC_AR_req,
