...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_MY_AXI_MASTER_FULL_ip_v1_0_Master_Full_AXI is
  ...
  signal M_AXI_BREADY_w : STD_LOGIC;
  attribute MARK_DEBUG of M_AXI_BREADY_w : signal is std.standard.true;
  signal M_AXI_BRESP_w : STD_LOGIC_VECTOR ( 1 downto 0 );
  attribute MARK_DEBUG of M_AXI_BRESP_w : signal is std.standard.true;
  signal M_AXI_BVALID_w : STD_LOGIC;
  attribute MARK_DEBUG of M_AXI_BVALID_w : signal is std.standard.true;
  ...
  signal axi_bready_reg0 : STD_LOGIC;
  ...
  signal write_resp_error_w : STD_LOGIC;
  attribute MARK_DEBUG of write_resp_error_w : signal is std.standard.true;
...
begin
  ...
  M_AXI_BRESP_w(1 downto 0) <= M_AXI_BRESP(1 downto 0);
  M_AXI_BVALID_w <= M_AXI_BVALID;
  M_AXI_RREADY <= \^m_axi_rready\;
  M_AXI_WDATA(31 downto 0) <= M_AXI_WDATA_w(31 downto 0);
  M_AXI_WDATA_w(31 downto 0) <= user_wr_data_in(31 downto 0);
  ...
  master_wr_addr(31 downto 0) <= M_AXI_AWADDR_w(31 downto 0);
  read_data_out(31 downto 0) <= \^m_axi_rdata\(31 downto 0);
  user_rd_data_en <= wnext_w;
...
write_resp_error_w_inferred_i_1: unisim.vcomponents.LUT3
    generic map(
      INIT => X"80"
    )
        port map (
