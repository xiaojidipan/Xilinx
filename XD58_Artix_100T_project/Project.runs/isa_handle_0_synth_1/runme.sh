...
HD_PWD='C:/XD58_test/XD58_Artix_100T_project/Project.runs/isa_handle_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log isa_handle_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source isa_handle_0.tcl
