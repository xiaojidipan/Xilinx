...
HD_PWD='E:/Xilinx/XD58_Project/XD58/XD58_Artix_100T_project/Project.runs/sub_BD_mig_7series_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sub_BD_mig_7series_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sub_BD_mig_7series_0_1.tcl
