...
#
# Generated by export_simulation on Fri Nov 17 16:45:00 +0800 2017
#
################################################################################
...
switch to the './Effective_mult_ip.sh' script.

./Effective_mult_ip.sh -reset_run
...
./Effective_mult_ip.sh -noclean_files

For more information on the script, please type './Effective_mult_ip.sh -help'.
